...
\newcommand{\examinerA}{Mark Lorenze D. Torregoza}
...
\newcommand{\groupID}{Aldwin & Friends} % group ID number is for undergraduates as of this formatting
...
\newcommand{\keywords}{Tracker, RFID, Scanner, Database}
